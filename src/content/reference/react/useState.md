...
<Intro>
 ...
 `useState` هو خطاف في React يتيح لك إضافة متغير حالة إلى مكونك
...
التقليد هو تسمية متغيرات الحالة بشكل مثل `[something, setSomething]` باستخدام [array destructuring] [تفكيك المصفوفة](https://javascript.info/destructuring-assignment)
...
* `useState` هو خطاف، لذلك يمكنك تسميتها فقط *** في المستوى الأعلى من مكوناتك *** أو الخطاطيف الخاصة بك. لا يمكنك تسميتها داخل الحلقات أو الظروف. إذا كنت بحاجة إلى ذلك، استخراج عنصر جديد وانقل الدولة فيه.
