...
>[الخطاطيف المُخصّصة](/learn/reusing-logic-with-custom-hooks) *من المُحتمل* أن تستدعي خطاطيف أُخرى (فذلك هو الهدف منها أساسًا). يعمل ذلك لأنه من المفروض أن الخطاطيف المُخصّصة تُستدعى فقط رَيْثَمَا يُصّيَّر يكون مكوّن الدالّة.
